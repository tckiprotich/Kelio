...
export default function Page () {
    ...
    useEffect(() => {
        fetch('/api/mentor')
            ...
            .then(data => setMentors(data.data)); // Change this line
    }, []);
        ...
        <div className="pt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {mentors.map((mentor, index) => (
                <div key={index} className='pt-10 mx-auto flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-6'>
                    ...
                    <a href={mentor.calendly} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
